...
const S = [
 ...
 ['2b', 'NhatKy (Nhật ký hoạt động)', 'Dòng thời gian MỌI sự kiện sổ cái, lọc theo nhóm; bấm một dòng → mở màn chuyên đề; trạng thái chuỗi băm', 'view.timeline', 'Mới v1.x (DEV-107) — màn duy nhất trả lời câu "tác tử vừa làm gì"'],
 ['7b', 'XungDot (Xung đột tri thức)', 'Hai bên đặt CÙNG HÀNG, mỗi bên kèm nguồn/tầng/độ tin; chọn A, chọn B, hoặc cả hai có điều kiện', 'kg.conflicts, kg.resolve_conflict', 'Mới v1.x (DEV-109) — trước đó kg.conflicts không gán màn nào, xem DEV-094'],
 ['8b', 'LamRo (Làm rõ yêu cầu)', 'Câu tác tử nói lại cách nó hiểu KÈM chuỗi bước sẽ chạy; câu hỏi gộp có phương án và mặc định; nút "Đúng — làm đi" / "Sửa ý hiểu"', 'chat.restate, chat.clarify, chat.parse_intent', 'Mới v1.x (DEV-109) — trước đó chỉ là một thẻ trôi trong dòng chat'],
