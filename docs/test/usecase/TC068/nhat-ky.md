...
Phiên	s_08beb2674f71
Mở lúc	23/09 07:49:24
Tự chủ hiệu lực	A2
Dừng khẩn	tắt
Lượt trao đổi	2
Mục hoàn tác	0
...
}  TÁC TỬ HỎI  ·  discover.auto_setup  discovery_id   …hoặc gõ câu trả lời khác Trả lời Lượt chạy DỪNG, đang chờ anh trả lời.   Thử: nhấp nháy LED và đo dòng tiêu thụ trên ESP32-C3 Gửi 
```
