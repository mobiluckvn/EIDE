# Toàn cảnh — TC013
Dự án: `/Users/congvt/Documents/EIDE/docs/test/usecase/TC013/du-an/noi-cam-bien-5v-vao-mcu-3v3`

## 1. Người gõ gì

```
# TC013 — Mức logic/điện áp không tương thích
@tao nối cảm biến 5V vào MCU 3V3
...
Dự án đang mở: noi-cam-bien-5v-vao-mcu-3v3.
...
human: Nối một cảm biến chạy 5V vào MCU chạy 3,3V qua I2C, vẽ giúp tôi sơ đồ nối dây
```
**Câu hỏi gửi lên**
 ...
 },
 {
  ...
  "data": {
   ...
   "error": {
    ...
    "eide_code": "E2000",
    "exists": [],
    "message": "Chưa có module nào — chạy `arch.decompose` trước; sơ đồ kiến trúc phải vẽ từ ModuleGraph có thật, không đoán",
    "missing": [
     "module"
    ],
...
Cần làm rõ	THIẾU THÔNG TIN	Bước `diagram.architecture` dừng: Chưa có module nào — chạy `arch.decompose` trước; sơ đồ kiến trúc phải vẽ từ ModuleGraph có thật, không đoán
...
**Quét 3 tab tác tử đã mở:** Main, Graph, DiagramView
...
![DiagramView](man-03-DiagramView.png)
...
Hết kịch bản — 3 bước. Ảnh và nhật ký trong `/Users/congvt/Documents/EIDE/docs/test/usecase/TC013`.
```
...
đã chụp /Users/congvt/Documents/EIDE/docs/test/usecase/TC013/man-01-Main.png
...
đã chụp /Users/congvt/Documents/EIDE/docs/test/usecase/TC013/man-02-Graph.png
...
![Graph](man-02-Graph.png)
  [cỡ] man-03-DiagramView 1456 × 838
đã chụp /Users/congvt/Documents/EIDE/docs/test/usecase/TC013/man-03-DiagramView.png
