...
}  TÁC TỬ HỎI  ·  ingest.index_text  Đọc những tệp nào? (đường dẫn đầy đủ)   …hoặc gõ câu trả lời khác Trả lời Lượt chạy DỪNG, đang chờ anh trả lời.   Thử: đối chiếu UR-PWR-01 với phần cứng thật (còn 2 yêu cầu chưa đối chiếu) Gửi 
```
...
```
ĐANG CHẠY  Không có lượt chạy nào.  CHỜ TÔI (14)  Làm rõ yêu cầu — FUNCTIONALITY  TV thường không tự cập nhật danh sách file khi có file mới được thêm vào ngầm (do cơ chế cache của hệ điều hành TV). Thiết bị sẽ xử lý việc này như thế nào để TV nhận diện phim mới?  Trả lời ở tab Làm rõ yêu cầu Làm rõ yêu cầu — THIẾU THÔNG TIN  Bước `ingest.index_text` đang chờ anh cho biết:
• Đọc những tệp nào? (đường dẫn đầy đủ) (`files`)  Trả lời ở tab Làm rõ yêu cầu Làm rõ yêu cầu — THIẾU THÔNG TIN  Bước `env.check` đang chờ anh cho biết:
• Chip của thiết bị thuộc kiến trúc tập lệnh nào? (cần để chọn chuỗi công cụ) (`isa`)
   Chọn một: armv7e-m — STM32F[2-4], STM32L4, nRF52, SAMD5; avr8 — ATmega, ATtiny, AVR(64|128); rv32imac — ESP32-?C[0-9], ESP32-?H[0-9], GD32V, CH32V  Trả lời ở tab Làm rõ yêu cầu Làm rõ yêu cầu — MECHANICAL  Có giới hạn nào về kích thước vật lý của thiết bị khi phải chứa thêm pin không?  Trả lời ở tab Làm rõ yêu cầu Làm rõ yêu cầu — POWER  Thiết bị lấy nguồn từ đâu?  Trả lời ở tab Làm rõ yêu cầu Làm rõ yêu cầu — POWER  Loại pin dự kiến sử dụng là gì và có cần mạch sạc tích hợp trên bo mạch không?  Trả lời ở tab Làm rõ yêu cầu Làm rõ yêu cầu — STORAGE  Thiết bị sẽ lưu trữ dữ liệu ở đâu?  Trả lời ở tab Làm rõ yêu cầu Làm rõ yêu cầu — FUNCTIONALITY  Thiết bị có cần cơ chế quản lý năng lượng như nút nguồn vật lý hay tự động ngủ/thức dậy theo trạng thái của TV không?  Trả lời ở tab Làm rõ yêu cầu … và 6 mục nữa — xem màn Nhật ký.  HOÀN TÁC ĐƯỢC (69)  view.rag_index  còn 23 giờ  Hoàn tác req.trace_matrix  còn 23 giờ  Hoàn tác req.trace_matrix  còn 23 giờ  Hoàn tác req.trace_matrix  còn 23 giờ  Hoàn tác req.trace_matrix  còn 23 giờ  Hoàn tác req.acceptance  còn 23 giờ  Hoàn tác req.trace_matrix  còn 23 giờ  Hoàn tác req.trace_matrix  còn 23 giờ  Hoàn tác … và 61 mục nữa — xem màn Nhật ký.  ⟩ 
```
