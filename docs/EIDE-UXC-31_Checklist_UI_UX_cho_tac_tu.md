...
- [x] **2.2** Cửa sổ tối thiểu 1100 × 700 pt; dưới ngưỡng thì cột phải thu thành dải icon 44 pt (badge vẫn hiện), KHÔNG được ẩn hẳn.  ·  **✔ `contentMinSize = 1100 × 700`; cột phải thu còn 44 pt với ba con số vẫn đọc được. §2.2 tự mâu thuẫn — một bề ngang tối thiểu đã cưỡng chế thì không bao giờ "dưới ngưỡng" được; đọc là TẠI ngưỡng, [DEV-139]. Ảnh `khung-toi-thieu.png` trong `--chup`**
