        ...
        if let i = args.firstIndex(of: "--chup"), i + 1 < args.count {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.4) {
                ...
                Task {
                    ...
                    for tien in ["Main", "ChinhSach", "NhatKy", "Passport", "XungDot", "Ingest", "Graph", "Board", "LamRo", "ReqArch", "DiagramView", "PlanDiff", "Doc", "Code", "DiffMerge", "Env", "Models", "ToolForge", "Registry"] {
